...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LALT(KC_ENT),   IJIMPORT,     KC_LALT,KC_LGUI,MO(SYMB),
        ...
        // right hand
             ...
             KC_EQL,      KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_RSPC,
                                MO(SYMB), LALT(LGUI(KC_NO)),KC_LEFT,KC_DOWN,KC_RGHT,
             MO(MDIA),  LCTL(KC_B),
             KC_HOME,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_UP,   KC_7,   KC_8,    KC_LBRC, KC_RBRC, KC_DEL,
                KC_DOWN, KC_4,   KC_5,    KC_LPRN, KC_RPRN, KC_TRNS,
       KC_RBRC, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
                         KC_TRNS,KC_DOT,  KC_0,    KC_EQL,  KC_TRNS,
       KC_LBRC  , KC_RBRC,
       LGUI(LSFT(KC_UP)),
       LGUI(LSFT(KC_DOWN)), RGB_TOG, KC_TRNS
),
