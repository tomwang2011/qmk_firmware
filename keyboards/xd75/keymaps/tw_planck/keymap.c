 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LCTL, KC_A,    KC_S,       KC_D,       KC_F,      KC_G,        LCTL(KC_T),   KC_PGUP,   KC_ENT,   KC_H,     KC_J,     KC_K,       KC_L,     KC_SCLN,  KC_QUOT },
  { KC_LSPO, KC_Z,    KC_X,       KC_C,       KC_V,      KC_B,        LALT(KC_C),   KC_PGDN,   KC_DEL,   KC_N,     KC_M,     KC_COMM,    KC_DOT,   KC_SLSH,  KC_RSPC },
 ...
 [_LW] = { /* Lower */
  { KC_TRNS, KC_F1,   KC_F2,      KC_F3,      	KC_F4,     	KC_F5,       KC_F6,        KC_F7,     KC_F8,       KC_F9,    KC_F10,   KC_F11,     KC_F12,   KC_TRNS,  KC_TRNS},
  { KC_TRNS, KC_EXLM, KC_UP,      KC_HASH,    	KC_DLR,    	KC_PERC,     PORTAL,       TOMCAT,    GITPSF,      KC_CIRC,  KC_AMPR,  KC_ASTR,    KC_MINS,  KC_EQL,   KC_TRNS},
  { KC_TRNS, KC_LEFT, KC_DOWN,    KC_RGHT,    	KC_TRNS,   	KC_TRNS,     TTAB,         GITRBI,    GITCMT,      KC_MS_L,  KC_MS_D,  KC_MS_U,    KC_MS_R,  KC_PGDN,  KC_ENT },
