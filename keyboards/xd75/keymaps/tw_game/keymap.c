 ...
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LSPO, KC_Z,    KC_X,       KC_C,       KC_V,      KC_B,        KC_MINS,      KC_PGDN,   KC_DEL,   KC_N,     KC_M,     KC_COMM,    KC_DOT,   KC_UP,  KC_RSPC },
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_TRNS, UNDO   , LCTL(KC_X), TCPY,         TPST,		     LCTL(KC_T),  LALT(KC_C),   IJCL,      IJFL,        KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_HOME,  KC_SLSH,    KC_END},
 ...
 [_LW] = { /* Lower */
  ...
  { KC_TRNS, UNDO   , LCTL(KC_X), TCPY,         TPST,		     LCTL(KC_T),  TRST,         TCPY,      TPST,        KC_TRNS,  KC_TRNS,  KC_TRNS,    KC_HOME,  KC_SLSH,    KC_END },
  { KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    	MO(_FN),   	KC_SPC,      LCTL(KC_MINS),MO(_TG),   LCTL(KC_EQL),KC_ENT,   MO(_LW),  KC_DEL,     KC_LEFT,  KC_DOWN,  KC_RGHT},
 },
